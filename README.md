# [DEPRECATED] Zendesk Support Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_zendesk`](https://github.com/fivetran/dbt_zendesk) instead, which now contains all models previously found here._
